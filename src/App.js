...
function PageTitle(props) {
  return <h2 style={{ backgroundColor: "green" }}>{props.children}</h2>;
}
...
function App() {
  ...
  return (
    <div className="App">
      <Layout name={name} ageCopy={ageCopy} age={age}>
        <main className="App-header">
          ...
          <p>
            Me gustan las películas, los videojuegos, la pizza, cerveza y las
            alitas.
          </p>
